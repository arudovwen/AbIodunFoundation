<template>
  <div class="grid grid-cols-2 gap-x-5">
    <div class="min-h-[90vh] p-6 max-w-[768px] mx-auto w-full">
      <div>
        <a-form
          name="register"
          :model="formState"
          ...
          <div class="grid gap-y-6">
            ...
            >
              ...
              <div v-if="activeTab.includes(id)" class="mt-6">
                ...
                <div class="mb-6">
                    <label class="flex items-center gap-x-3"> <input type="checkbox" v-model="n.required" /> <span>Required</span></label>
                </div>
                </div>
